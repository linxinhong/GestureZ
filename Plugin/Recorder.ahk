...
( Join`n `
en,cn
Recorder by Titan,Recording by Titan (ÐÞ¸Ä×ÔArray)
Recording options,Ñ¡Ïî
&Time intervals,¼ä¸ô(&T)
&Window actions,¶¯×÷(&W)
&Use control commands,&Control ÃüÁî
&Keyboard actions,&¼üÅÌ¶¯×÷
Mouse c&licks,&Êó±ê¶¯×÷
&Movements,&Movements
Rel,Rel
Hotkeys,ÈÈ¼ü
...
Save:
GuiControlGet, scr, , scr
scr := "`n`; ´Ë´úÂëÓÉRecorder²å¼þÉú³É`n" . scr "`n`; Recorder´úÂë½áÊø"
Controlsettext,Edit1,%scr%,ahk_class AutoHotkeyGUI,_GestureZ
ExitApp
/*
Gui, +OwnDialogs
